"""
Django settings for taxi_46814 project.
...
WSGI_APPLICATION = 'taxi_46814.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "taxi_46814 API",
    "DESCRIPTION": "API documentation for taxi_46814 App",
    "VERSION": "v1",
}
